-- Add unique constraint to market_items name
ALTER TABLE market_items
ADD CONSTRAINT market_items_name_key UNIQUE (name);

-- Drop and recreate the buy_item function with proper handling of inventory
...
-- Add RLS policy for the buy_item function
